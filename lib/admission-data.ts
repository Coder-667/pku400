...
export const trendAnalysis = {
  summary: "北大软微11408竞争持续白热化。2021年复试线345，2024年直接飙到380，三年涨35分。2025年回落至357，但报考人数持续增长（~2500人），录取难度未实质性降低。",
  warning: "录取均分从2021年的367涨到2024年的397，接近400分。2025年均分382，说明即使分数线回落，高分考生集中度仍在。目标分数建议定在390-400之间方有较稳把握。",
  advice: "初试是门槛，但复试是决胜场。每年都有高分被刷、偏低分逆袭的案例。初试备考的同时，注重编程机试能力和专业基础知识的广度深度积累。",
};
